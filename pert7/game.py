...
class Player:
    ...
    def memilih(self):
        self.pilihan = input(f"{self.nama}, masukan pilihan(Batu, Gunting, Kertas): ").lower()
...
class Game:
    ...
    def menentukan_pemenang(self):
        ...
        elif (self.player.pilihan == 'batu' and
                self.computer.pilihan == 'gunting') or \
             (self.player.pilihan == 'gunting' and 
              self.computer.pilihan == 'kertas') or \
             (self.player.pilihan == 'kertas' and 
              self.computer.pilihan == 'batu'):
    ...
    def play(self):
        ...
        print(f"{self.player.nama} chose {self.player.pilihan}")
